...
class ScrollBox
  ...
  componentDidMount(): void {
    ...
    if (!this.props.noStopPageScroll){
      this.moveBar.current!.parentElement!.parentElement!.addEventListener("wheel",this.stopWhell,{passive:false});
    }
  }

  componentWillUnmount(){
    if (!this.props.noStopPageScroll){
      this.moveBar.current!.parentElement!.parentElement!.removeEventListener("wheel",this.stopWhell);
    }
  }
  ...
  upDateInit =(defaultH?:number):void => {
    ...
    this.scrollBoxH =defaultH ? defaultH : barInner.parentElement!.parentElement!.clientHeight;
  ...
  cancelBarMove = (): void => {
    this.moveBar.current!.parentElement!.parentElement!.removeEventListener("mousemove",this.barMoveEven);
  }
