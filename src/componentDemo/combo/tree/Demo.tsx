...
import {data, str4, str1, str2, str3 } from "./CodeStr";
...
class Demo extends React.PureComponent<Props, States> implements IDemo {
  ...
  inpChangeFn = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    let value:string | boolean | number = dom.value;
            ...
            <div>
              ...
              <div className="inp-item">
                <Input
                  ...
                  type="number"
                  changeFn={this.inpChangeFn}
                  value={maxHeight ?  String(maxHeight) : '0'}
                >
                  下拉框最大高度 maxHeight:
                </Input>
              </div>
              <div className="inp-item">
                <Input
                  ...
                  type="number"
                  changeFn={this.inpChangeFn}
                  value={dropWidth ? String(dropWidth) : '0'}
                >
                  下拉框宽度 dropWidth:
                </Input>
              </div>
